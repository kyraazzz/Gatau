$(document).ready(function () {
    ...
    var content = [{
        ...
        title: "I Have Crush On You!!",
        desc: "mungkin itu sebuah kalimat yg cukup simple, kalimat yang menyimpan banyak harapan juga keraguan dibaliknya. ada harapan yg ingin rasa suka itu tidak jatuh sendirian, juga ada yang harus disiapkan agar bisa menerima konsekuensinya."
    }, {
       title: "",
       desc: "menyatakan perasaan itu hal yang cukup serius, banyak yang akan dikorbankan termasuk hasil akhirnya melepas hal yang sudah Iama tersimpan itu cukup melegakan dan bukan hal yang mudah. disini aku cuman mau ungkapin perasaan aku sama kamu, masalah diterima atau ngga itu tergantung kamu nya, aku juga gak bakal berharap lebih kok"
    }, {
        title: "",
        desc: "kalau kamu risih bilang yahh,'I Have Crush On You', semisal kamu udah punya pacar maaf yaa karna udah confess ke kamu. . . mungkin segitu saja dari aku, hehe makasiii yaa sudaaa mau dibaca."
    }, {
        title: "I Have Crush On You!!",
